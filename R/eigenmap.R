...
#' details).
#' @param boundaries When required by \code{weighting}, a two-element numeric
...
#' @param wpar Shape parameter for \code{weignting} (optional).
...
#' @param emap An \code{\link{eigenmap-class}} object.
#' @param target A matrix of the distances between the locations passed to
...
#' 
#' @details When \code{eigenmap} is given coordinates as its argument \code{x},
...
#' 
#' @examples ### Example 1: A linear transect.
#' data(salmon)
#' 
